...
public class ObjectFactory {
    ...
    private final static QName _ProcessOrder_QNAME = new QName("http://localhost:8888/v1/order", "processOrder");
    private final static QName _ProcessOrderResponse_QNAME = new QName("http://localhost:8888/v1/order", "processOrderResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://localhost:8888/v1/order", name = "processOrder")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://localhost:8888/v1/order", name = "processOrderResponse")
